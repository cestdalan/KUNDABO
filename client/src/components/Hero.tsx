        ...
        <div className="lg:col-span-5 relative h-[360px] md:h-[450px] w-full flex items-center justify-center lg:justify-end">
          ...
          >
            ...
            <div>
              ...
              <p className="text-accent-light text-xs font-medium mt-0.5">From RWF 35,000</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-accent-light text-xs font-medium mt-0.5">Clay & Glass • RWF 24,000</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-accent-light text-xs font-medium mt-0.5">Best Seller • RWF 45,000</p>
            </div>
          </motion.div>
        </div>
      </div>
