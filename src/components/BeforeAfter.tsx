...
const PORTFOLIO_PROJECTS = [
  {
    id: 1,
    title: 'Signature Macrame Flower Bouquets',
  ...
  {
    id: 2,
    title: 'Premium Estate Greenery & Lawn',
  ...
  {
    id: 3,
    title: 'Elegant Vase & Boutique Display',
  ...
  {
    id: 4,
    title: 'Fresh Crimson Dewy Roses',
    category: 'Bespoke Flowers',
    image: '/portfolio_2.jpg',
    gridClass: 'md:col-span-1 md:row-span-1',
  },
  {
    id: 5,
    title: 'Premium Close-Up Red Rose',
